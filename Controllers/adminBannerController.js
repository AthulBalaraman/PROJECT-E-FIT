...
const showBannerPage = (req,res)=>{
  bannerModel.showBanner().then((banners)=>{
    res.render('admin/adminBannerPage',{admin:true,title:'BANNER CONTROL PAGE',banners})
  })
}
...
bannerModel.inserBanner({ bannerImage:req.file.filename,bannerName,bannerOffer
}).then((response)=>{
